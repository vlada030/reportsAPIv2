...
const ExpReportSchema = new mongoose.Schema({
    ...
    duzina_1: {
        ...
        max: [12000, 'Najveća dužina koju možete uneti je 12 000m']
    },

    dobos_2: {
        type: String,
        validate: [function() {
            return this.dobos_2.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_10: {
        type: String,
        validate: [function() {
            return this.dobos_10.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_11: {
        type: String,
        validate: [function() {
            return this.dobos_11.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_12: {
        type: String,
        validate: [function() {
            return this.dobos_12.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_13: {
        type: String,
        validate: [function() {
            return this.dobos_13.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_14: {
        type: String,
        validate: [function() {
            return this.dobos_14.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_15: {
        type: String,
        validate: [function() {
            return this.dobos_15.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_16: {
        type: String,
        validate: [function() {
            return this.dobos_16.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_17: {
        type: String,
        validate: [function() {
            return this.dobos_17.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_18: {
        type: String,
        validate: [function() {
            return this.dobos_18.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_19: {
        type: String,
        validate: [function() {
            return this.dobos_19.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
    ...
    dobos_20: {
        type: String,
        validate: [function() {
            return this.dobos_20.length === 10;
        } , 'Oznaka doboša mora da sadrzi 10 znaka']
    },
