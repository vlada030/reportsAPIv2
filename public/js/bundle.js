...
exports.updateProduct = exports.deleteReport = exports.getProduct = void 0;
...
_axios.default.defaults.headers.common['X-CSRF-TOKEN'] = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
...
exports.itemsListArray = exports.updateTotalLength = exports.delItem = exports.addItem = exports.updateProductUI = exports.updateReportsUI = exports.elements = void 0;
var elements = {
  // zajednicki elementi
  // logovanje
...
var updateReportsUI = function updateReportsUI(elem) {
  if (elem) {
    ...
    elements.standard.innerText = elem.propis || "/"; // boja postoji samo u exp Reports
...
var addItem = function addItem(n) {
  var elem = "<div class=\"row mb-2 marker\" data-next=".concat(+n + 1, "><div class=\"col-6\"><input class=\"form-control text-right font-weight-bold item\" type=\"text\" name=\"dobos_").concat(n, "\"  value='/'><small>Error message</small></div><div class=\"col-6 input-group\"><input class=\"form-control text-right font-weight-bold itemLength\" type=\"number\" name=\"duzina_").concat(n, "\"  value='0'><div class=\"input-group-append\"><span class=\"input-group-text\">m</span></div></div></div>");
...
var itemsListArray = function itemsListArray() {
  return document.querySelectorAll('#drumList .item');
}; // preracun total polja nakon dodaj / oduzmi item


exports.itemsListArray = itemsListArray;

function calcTotalLength() {
  var arr = Array.from(document.querySelectorAll('.itemLength'));
