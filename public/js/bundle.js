        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:5000/api/v2/products/".concat(productCode.value.trim(), "/json")
            });
...
var showMessage = function showMessage(message, type) {
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>"); // pre prikazivanje nove poruke obriši staru
