...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"ajaxRequests.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getAdvancedResultsData = exports.updateForgottenPassword = exports.deleteUserAvatar = exports.updateUserDetail = exports.updateProduct = exports.deleteReport = exports.getProduct = void 0;
...
_axios.default.defaults.headers.common['X-CSRF-TOKEN'] = document.querySelector('meta[name="csrf-token"]').getAttribute('content'); //axios.defaults.withCredentials = true;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(baseURL, "/api/v2/products/").concat(value, "/json")
            });
...
var updateProduct = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(value, data) {
    var result;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0, _axios.default)({
              url: "".concat(baseURL, "/api/v2/products/").concat(value),
              method: 'PUT',
              data: data
            });
...
var updateForgottenPassword = /*#__PURE__*/function () {
  ...
  return function updateForgottenPassword(_x8, _x9) {
...
var getAdvancedResultsData = /*#__PURE__*/function () {
  ...
  return function getAdvancedResultsData(_x10) {
    return _ref7.apply(this, arguments);
  };
}();

exports.getAdvancedResultsData = getAdvancedResultsData;
...
exports.deleteMessage = exports.showMessage = void 0;

// prikazivanje poruka nakon manipulacije na FE
// generisanje poruke
var showMessage = function showMessage(message, type) {
  //const markup = `<div class="alert alert--${type}">${message}</div>`;
  var markup = "<div class=\"alert alert--".concat(type, "\"><p>").concat(message, "</p><p class=\"close\">&times;</p></div>"); // pre prikazivanje nove poruke obriši staru

  deleteMessage();
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); //window.setTimeout(deleteMessage, 2000)
}; // brisanje poruke
...
},{}],"errorHandler.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(error) {
  ...
  if (error.response) {
    ...
    if (error.response.status === 500) {
      ...
      (0, _alertMessage.showMessage)('Greska prilikom validacije axios PUT requesta', 'error');
      ...
      (0, _alertMessage.showMessage)('Neispravan token. Obratite pažnju da imate 10 minuta od momenta pristizanja emaila da resetujete zaboravljenu šifru.', 'error');
      ...
      (0, _alertMessage.showMessage)('Proizvod sa zadatom sifrom ne postoji u sistemu', 'error');
      ...
      (0, _alertMessage.showMessage)(error.response.data.error, 'error');
    }
    ...
    (0, _alertMessage.showMessage)(error.message, 'error');
  }
};

exports.default = _default;
},{"./alertMessage":"alertMessage.js"}],"userInterface.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderPaginatedUI = exports.removeItemProboj = exports.addItemProboj = exports.removeItemDorada = exports.addItemDorada = exports.removeWorker = exports.addWorker = exports.updateTotalLength = exports.delItem = exports.addItem = exports.updateProductUI = exports.updateReportsUI = exports.elements = void 0;
var elements = {
...
var updateReportsUI = function updateReportsUI(elem) {
  if (elem) {
    elements.cableType.innerText = elem.proizvod || "/";
    elements.ratedVoltage.innerText = elem.napon || "/";
    elements.standard.innerText = elem.propis || "/"; // boja postoji samo u exp Reports, ne u dom Reports
    ...
    elements.standard.innerText = "/"; // jedino boja postoji samo u index.html / index-ino.html
...
exports.updateReportsUI = updateReportsUI;

var updateProductUI = function updateProductUI(elem) {
  if (elem) {
...
var delItem = function delItem() {
  var elem = document.querySelector('#drumList .marker:last-child');
...
var updateTotalLength = function updateTotalLength() {
  var arr = Array.from(document.querySelectorAll('#drumList input[type="number"]'));
  elements.totalLength.value = calcTotalLength(arr);
}; // preracun total polja nakon dodaj / oduzmi item


exports.updateTotalLength = updateTotalLength;
...
var renderPaginatedUI = function renderPaginatedUI(input, currentPage, limit, lastPage, type) {
  ...
  productsArray.forEach(function (elem, ind) {
    ...
    if (type === 'dom') {
      markup = "<a class=\"list-group-item list-group-item-action d-flex justify-content-between\" href=\"/api/v2/reports/dom?id=".concat(elem.MISBroj, "\"><span class=\"w-25 px-2\">").concat(no, ".</span><span class=\"w-25 px-2\">MIS Broj: ").concat(elem.MISBroj, "</span><span class=\"w-25 px-2\">Nalog: ").concat(elem.radniNalog, "</span><span class=\"w-25 px-2\">").concat(elem.proizvod.proizvod, "</span><span class=\"w-25 text-right px-2\">").concat(elem.proizvod.napon, "</span><span class=\"w-25 text-right px-2\">").concat(elem.duzina, "m</span></a>");
    } else if (type === 'exp') {
      var options = {
        weekday: 'long',
        year: 'numeric',
      ...
      markup = "<a class=\"list-group-item list-group-item-action d-flex justify-content-between\" href=\"/api/v2/reports/exp?id=".concat(elem._id, "\"><span class=\"w-25 px-2\">").concat(no, ".</span><span class=\"w-25 px-2\">").concat(elem.proizvod.proizvod, "</span><span class=\"w-25 px-2\">Ukupna duzina: ").concat(elem.ukupnaDuz, "m</span><span class=\"w-25 px-2\">Kreiran: ").concat(elem.createdAt.toLocaleString('sr-sr', options), "</span></a>");
    } else {
      var _options = {
        weekday: 'long',
        year: 'numeric',
      ...
      markup = "<a class=\"list-group-item list-group-item-action d-flex justify-content-between\" href=\"/api/v2/reports/shift/".concat(elem._id, "\"><span class=\"w-25 px-2\">").concat(no, "</span><span class=\"w-25 px-2\">Kreiran: ").concat(elem.createdAt.toLocaleString('sr-sr', _options), "</span><span class=\"w-25 px-2\">Smena: ").concat(elem.smena, "</span><span class=\"w-25 px-2\">Kontrolor: ").concat(elem.createdByUser.name, "</span></a>");
    }
...
var _ajaxRequests = require("./ajaxRequests");
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _userInterface.elements.saveButton.removeAttribute('disabled');

              _userInterface.elements.savePDFButton.removeAttribute('disabled'); // NE PRAVI NEPOTREBAN ZAHTEV AKO SIFRA NIJE DUŽINE 7


              if (!(_userInterface.elements.productCode.value.trim().length !== 7)) {
                _context.next = 10;
                break;
              }

              // blokiraj SAVE button
              _userInterface.elements.saveButton.setAttribute('disabled', 'true');

              _userInterface.elements.savePDFButton.setAttribute('disabled', 'true');

              throw new Error('Šifra proizvoda se sastoji iz 7 cifara');

            case 10:
              _context.next = 12;
              return (0, _ajaxRequests.getProduct)(_userInterface.elements.productCode.value.trim());
...
if (_userInterface.elements.updateProductCode) {
  _userInterface.elements.updateProductCode.addEventListener('input', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              (0, _userInterface.updateProductUI)(void 0); // proveri button SAVE / PDF da li su disabled

              _userInterface.elements.saveUpdateButton.removeAttribute('disabled'); // NE PRAVI NEPOTREBAN ZAHTEV AKO SIFRA NIJE DUŽINE 7


              if (!(_userInterface.elements.updateProductCode.value.trim().length !== 7)) {
                _context2.next = 8;
                break;
              }

              // blokiraj SAVE button
              _userInterface.elements.saveUpdateButton.setAttribute('disabled', 'true');
            ...
            case 8:
              ...
              _context2.next = 11;
              return (0, _ajaxRequests.getProduct)(updateProductCode.value.trim());
            ...
            case 11:
              ...
              if (product) {
                // AKO POSTOJI PROIZVOD UPDATE UI
                console.log(product.data.data[0]);
                (0, _userInterface.updateProductUI)(product.data.data[0]);
              }
            ...
            case 15:
              ...
              (0, _errorHandler.default)(_context2.t0);
...
if (_userInterface.elements.productHandleForm && _userInterface.elements.saveUpdateButton) {
  _userInterface.elements.saveUpdateButton.addEventListener('click', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var data, formData, result;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              _context4.prev = 1;
              data = {}; // obriši alert poruku ako je ima

              (0, _alertMessage.deleteMessage)(); // pretvori node list u array

              formData = Array.from(_userInterface.elements.productHandleForm.elements); // kreiraj data object {name: value} i izbaci button element i csrf token input
              ...
              _context4.next = 8;
              return (0, _ajaxRequests.updateProduct)(data.sifra, data);
            ...
            case 13:
              ...
              (0, _errorHandler.default)(_context4.t0);
...
if (_userInterface.elements.expReportsForm) {
  // dodaj stavku
  _userInterface.elements.addItemButton.addEventListener('click', function (e) {
  ...
  _userInterface.elements.delItemButton.addEventListener('click', function (e) {
    e.preventDefault(); // obriši poruku ako postoji

    (0, _alertMessage.deleteMessage)(); // obrisi stavku

    (0, _userInterface.delItem)(); // preracunaj ponovo ukupnu duzinu
...
if (_userInterface.elements.updateNameForm) {
  _userInterface.elements.submitName.addEventListener('click', /*#__PURE__*/function () {
...
if (_userInterface.elements.updateEmailForm) {
  _userInterface.elements.submitEmail.addEventListener('click', /*#__PURE__*/function () {
...
if (_userInterface.elements.updatePasswordForm) {
  _userInterface.elements.submitPassword.addEventListener('click', /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(e) {
      var currentPassword, newPassword, user;
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              e.preventDefault();
              (0, _alertMessage.deleteMessage)();
              currentPassword = _userInterface.elements.currentPassword.value;
...
if (_userInterface.elements.forgottenPasswordForm) {
  _userInterface.elements.submitForgottenPassword.addEventListener('click', /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(e) {
      var password, currentUrl, user;
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              e.preventDefault();
              (0, _alertMessage.deleteMessage)();
              password = _userInterface.elements.forgottenPassword.value;
              currentUrl = window.location.href;
              _context10.prev = 4;
              _context10.next = 7;
              return (0, _ajaxRequests.updateForgottenPassword)(currentUrl, password);

            case 7:
              user = _context10.sent;
              (0, _alertMessage.showMessage)('Šifra je uspešno promenjena. Ulogujte se ponovo.', 'success');
              window.setTimeout(function () {
                window.close();
              }, 1500);
              _context10.next = 15;
            ...
            case 12:
              ...
              (0, _errorHandler.default)(_context10.t0);
...
[_userInterface.elements.btnFirstPage, _userInterface.elements.btnLastPage, _userInterface.elements.btnPrevPage, _userInterface.elements.btnMiddlePage, _userInterface.elements.btnNextPage].forEach(function (elem) {
  if (elem) {
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                path = extractedUrl.includes('dom') ? 'dom' : extractedUrl.includes('exp') ? 'exp' : 'shift';
...
if (_userInterface.elements.itemsPerPage) {
  _userInterface.elements.itemsPerPage.addEventListener('change', /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(e) {
      var currentUrl, path, limit, url, results, lastPageNumber, currentPageNumber;
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              e.preventDefault();
              currentUrl = window.location.href;
              path = currentUrl.includes('dom') ? 'dom' : currentUrl.includes('exp') ? 'exp' : 'shift';
              limit = _userInterface.elements.itemsPerPage.value;
              url = "/api/v2/reports/".concat(path, "/json?limit=").concat(limit); // pozovi ajax i pokupi podatke za traženu stranu
...
if (_userInterface.elements.filterProductName) {
  [_userInterface.elements.filterProductName, _userInterface.elements.fltByName, _userInterface.elements.fltByCode].forEach(function (elem) {
    elem.addEventListener("input", function (e) {
      e.preventDefault();

      var term = _userInterface.elements.filterProductName.value.trim().toUpperCase();

      var productsArray = Array.from(document.querySelectorAll(".item"));
      var counter = 0;
      var searchBy = _userInterface.elements.fltByName.checked ? ".name" : ".code";
      productsArray.forEach(function (el) {
        var name = el.querySelector(searchBy).innerText;
      ...
      if (counter === 1) {
        _userInterface.elements.itemsCounter.innerText = "Prona\u0111ena je 1 stavka";
      } else {
        _userInterface.elements.itemsCounter.innerText = "Prona\u0111ene su ".concat(counter, " stavke");
      }
    });
  });
}
