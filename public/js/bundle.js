...
var _default = function _default(error) {
  console.log('catch petlja'); // console.log('X', error)
...
var savePDFButton = document.getElementById('savePDF'); // provera da li postoji proizvod sa zadatom šifrom dom/exp Reports
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              saveButton.removeAttribute('disabled'); // NE PRAVI NEPOTREBAN ZAHTEV AKO SIFRA NIJE DUŽINE 7
...
window.addEventListener('click', function (e) {
  ...
  if (e.target.matches('#eraseReport')) {
    try {
      var eraseID = e.target;
      console.log(eraseID.dataset.reportid);
      (0, _ajaxRequests.deleteReport)(eraseID.dataset.reportid);
...
saveButton.addEventListener('click', function (e) {
  e.preventDefault();
  var data = {};
  var formData = Array.from(document.getElementById("productHandleForm").elements);
  ...
  console.log(data);
  (0, _ajaxRequests.updateProduct)(data.sifra, data);
});
