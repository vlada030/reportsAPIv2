...
exports.updateProductUI = exports.updateReportsUI = void 0;
var elements = {
  // zajednicki elementi
  // logovanje
...
var updateReportsUI = function updateReportsUI(elem) {
  if (elem) {
    ...
    elements.standard.innerText = elem.propis || "/"; // jedino boja postoji samo u index.html / index-ino.html
...
var updateProductCode = document.getElementById('updateProductCode');
var saveButton = document.getElementById('save');
var savePDFButton = document.getElementById('savePDF');
var saveUpdateButton = document.getElementById('saveProductUpdate'); // provera da li postoji proizvod sa zadatom šifrom dom/exp Reports
...
if (updateProductCode) {
  updateProductCode.addEventListener('input', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              saveUpdateButton.removeAttribute('disabled'); // NE PRAVI NEPOTREBAN ZAHTEV AKO SIFRA NIJE DUŽINE 7
...
var resetDomReportsForm = function resetDomReportsForm() {
...
if (saveUpdateButton) {
  saveUpdateButton.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              formData = Array.from(document.getElementById("productHandleForm").elements); // kreiraj data object {name: value} i izbaci button element i csrf token input
